...
import com.investokar.poppi.view.ResizableImageView;
...
public class ChatListAdapter extends BaseAdapter implements Constants {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (App.getInstance().getId() == chatItem.getFromUserId()) {
            ...
            if (chatItem.getFromUserPhotoUrl() != null && !chatItem.getFromUserPhotoUrl().trim().isEmpty()) {
                Picasso.get()
            ...
            if (chatItem.getImageUrl() != null && !chatItem.getImageUrl().trim().isEmpty()) {
                ...
                viewHolder.mRight_Img.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("imageUrl", chatItem.getImageUrl());

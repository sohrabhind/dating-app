package com.investokar.poppi.app;
...
import com.investokar.poppi.model.Settings;
...
public class App extends Application implements Constants {
    ...
    private long id = 0;
    private int gender = 0, state = 0, balance = 0, level = 0, freeMessagesCount = 0, levelMessagesCount = 0, allowShowOnline = 0, errorCode = 0, currentChatId = 0, notificationsCount = 0, messagesCount = 0, newFriendsCount = 0, seenTyping = 1;
    ...
    public Boolean authorize(JSONObject authObj) {
        ...
        try {
            ...
            if (accountArray.length() > 0) {
                ...
                this.setGender(accountObj.getInt("gender"));

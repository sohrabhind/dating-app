...
package com.investokar.poppi.tagview;


import static com.investokar.poppi.tagview.Utils.dp2px;
import static com.investokar.poppi.tagview.Utils.sp2px;
...
public class TagContainerLayout extends ViewGroup {
    ...
    /**
     * The max length for TagView(default max length 25)
     */
    private int mTagMaxLength = 500;
     ...
     */
    private int mTagBorderColor = Color.parseColor("#000000");
    ...
    /**
     * TagView text color(default #FFFFFF)
     */
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        @SuppressLint("CustomViewStyleable") TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.AndroidTagView,
                defStyleAttr, 0);
...
//        int widthSpecMode = MeasureSpec.getMode(widthMeasureSpec);
    ...
    public void setTagMaxLength(int maxLength) {
        mTagMaxLength = Math.max(maxLength, TAG_MIN_LENGTH);
    }
